...
namespace Kino
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //senase
            Seans seans = new Seans(film1, sala01, new DateTime(2022,01,21,10,00,00));
            Seans seans2 = new Seans(film2, sala02, new DateTime(2022, 01, 21, 9, 00, 00));
            Seans seans3 = new Seans(film2, sala02, new DateTime(2022, 01, 22, 14, 00, 00));
            Seans seans4 = new Seans(film2, sala02, new DateTime(2022, 01, 21, 13, 00, 00));
            Seans seans5 = new Seans(film3, sala01, new DateTime(2022, 01, 23, 18, 00, 00));
            Seans seans6 = new Seans(film3, sala02, new DateTime(2022, 01, 23, 18, 00, 00));
            Seans seans7 = new Seans(film3, sala02, new DateTime(2022, 01, 23, 22, 00, 00));
            Seans seans8 = new Seans(film1, sala03, new DateTime(2022, 01, 22, 18, 00, 00));
            Seans seans9 = new Seans(film4, sala03, new DateTime(2022, 01, 22, 15, 00, 00));
            Seans seans10 = new Seans(film4, sala03, new DateTime(2022, 01, 22, 10, 00, 00));
            ...
            Harmonogram.ZapiszXML("harmonogram.xml", Ogolny);
